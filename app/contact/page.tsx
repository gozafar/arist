...
export const generateMetadata = async (): Promise<Metadata> => {
  ...
  const description =
    `Reach out for original paintings, commissions, or worldwide shipping to ${config.label}.`;
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. We ship worldwide with insurance, tracking, and customs guidance for UAE, India, USA, and Hong Kong."
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most international orders ship within 7–10 business days depending on size, framing, and destination."
        }
      }
    ]
  };
