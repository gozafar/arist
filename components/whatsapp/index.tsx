...
const FloatingWhatsApp: React.FC<FloatingWhatsAppProps> = ({
  ...
  return (
    ...
    >
      <div className='relative flex items-center gap-2.5 bg-[#25D366] text-white px-5 py-3 rounded-full shadow-lg border-2 border-white/20'>
        ...
        <span className='font-semibold text-[15px] poppins-semibold tracking-wide'>Chat with us</span>
